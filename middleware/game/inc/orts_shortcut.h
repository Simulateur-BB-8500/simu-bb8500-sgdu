...
#define ORTS_SHORTCUT_PRESS_DURATION_MS_DEFAULT     50
...
// FPB.
static const KEYBOARD_shortcut_t ORTS_SHORTCUT_FPB_APPLY =          (KEYBOARD_shortcut_t ) { VK_OEM_3, VK_NONE };
static const KEYBOARD_shortcut_t ORTS_SHORTCUT_FPB_RELEASE =        (KEYBOARD_shortcut_t ) { 'M', VK_NONE };
// FD.
static const KEYBOARD_shortcut_t ORTS_SHORTCUT_FD_APPLY =           (KEYBOARD_shortcut_t ) { VK_OEM_1, VK_NONE };
static const KEYBOARD_shortcut_t ORTS_SHORTCUT_FD_RELEASE =         (KEYBOARD_shortcut_t ) { VK_OEM_6, VK_NONE };
// BPURG.
